 ...
 *           1. SessionKeyWallet  (AEG-7 risk-guarded ERC-4337 wallet)
 *           2. ProofOfRationalityVerifier  (AEG-9 Ultra Honk SNARK verifier)
 *           3. Wires verifier address into SessionKeyWallet
 *           4. Registers wallet with AEGTreasury
 *           5. Emits final deployment manifest
 *
 * Usage (Base Sepolia):
 ...
 *
 * Base Sepolia constants (hardcoded, public — no secret):
 ...
 *
 * Post-deploy:
 *   export SESSION_WALLET_ADDRESS=<printed address>
 *   export VERIFIER_ADDRESS=<printed address>
 *   Then update src/k9_proof_shim.py + launch-economic-stack.sh
 */
...
contract DeployAEG6 is Script {
    ...
    function run() external returns (Deployment memory d) {
        ...
        // Generated by: bb contract -k contracts/aeg9_circuit/vk -o contracts/src/ProofOfRationalityVerifier.sol
        ...
        console2.log("Address:", d.verifier);
        ...
        console2.log("Address:     ", d.wallet);
        console2.log("Owner:       ", owner);
        console2.log("Session Key: ", sessionKey);
        console2.log("Params Hash: ");
        console2.logBytes32(d.paramsHash);

        // ── Step 3: Wire verifier → wallet ────────────────────────────────────
        // SessionKeyWallet.setVerifier() gates executeBundle() on proof validity
        wallet.setVerifier(d.verifier);

        console2.log("=== [3/3] Verifier wired to wallet ===");
        console2.log("wallet.verifier() →", wallet.verifier());
        ...
        console2.log("╠══════════════════════════════════════════════════╣");
        console2.log("║ SessionKeyWallet   :", d.wallet);
        console2.log("║ ProofOfRatVerifier :", d.verifier);
        console2.log("║ Params Hash        :");
        console2.logBytes32(d.paramsHash);
        console2.log("╠══════════════════════════════════════════════════╣");
        ...
        console2.log("║ Verifier generated by: bb contract -k vk          ║");
        console2.log("╚══════════════════════════════════════════════════╝");
        console2.log("");
        console2.log("NEXT STEPS:");
        console2.log("  export SESSION_WALLET_ADDRESS=", d.wallet);
        console2.log("  export VERIFIER_ADDRESS=", d.verifier);
        console2.log("  Update src/k9_proof_shim.py SESSION_WALLET_ADDRESS");
        console2.log("  Update launch-economic-stack.sh env block");
        console2.log("  Verify on Basescan: https://sepolia.basescan.org/address/", d.wallet);
    }
}
